...
const ROUTE_IMAGES = {
  ...
  maxwellApproach: "/demo-images/streetview/10-maxwell-roofline.jpg",
  kadayanallurCorner: "/demo-images/streetview/maxwell-food-centre-streetview.jpg",
  maxwellArrive: "/demo-images/streetview/maxwell-food-centre-streetview.png",
};
...
export const DEMO_ROUTE: NavigationRoute = {
  ...
  steps: [
    ...
    demoStep({
      step_index: 10,
      instruction: "Continue downhill through the service lane",
      distance_text: "115m",
      duration_seconds: 45,
      target_bearing: 161,
      ...
      landmark: {
        name: "Ann Siang service lane",
        category: "Downhill approach",
        image_url: ROUTE_IMAGES.maxwellApproach,
        photo_query: "Ann Siang Road Singapore Maxwell approach",
        coordinate: { lat: 1.28079, lng: 103.84556 },
        confidence: 0.9,
      },
      action_icon: "straight",
    ...
    demoStep({
      step_index: 11,
      instruction: "Turn left at Kadayanallur Street toward Maxwell frontage",
      distance_text: "55m",
      duration_seconds: 35,
      target_bearing: 229,
      ...
      landmark: {
        name: "Kadayanallur Street corner",
        category: "Final corner",
        image_url: ROUTE_IMAGES.kadayanallurCorner,
        photo_query: "Kadayanallur Street Maxwell Food Centre Singapore",
        coordinate: { lat: 1.280205, lng: 103.845238 },
        confidence: 0.95,
      },
      action_icon: "turn-left",
